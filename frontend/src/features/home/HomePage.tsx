...
export default function HomePage(): JSX.Element {
    ...
    const effectivePageCount = Math.max(1, Math.ceil(visibleStudies.length / pageSize))
        ...
        <div className="flex flex-col gap-8">
            ...
            <KpiGrid columns={5}>
                ...
                <KpiCard
                    ...
                    subtitle={stats ? `${stats.studies_active} ${t("studies.tabs.active").toLowerCase()}` : "total"}
...
function FirstStudyHero({
    ...
    return (
        <div className="flex flex-col items-center gap-6 rounded-merism-lg bg-merism-surface p-16 text-center shadow-merism-card ring-1 ring-[color:var(--merism-hairline)]">
            <Illustration name="planning-a-trip" size="xl" className="text-merism-text" />
