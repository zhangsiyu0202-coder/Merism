      ...
      DEFAULT_QUESTIONS,
      {
        ...
        addQuestion: (state, { type }) => [
          ...state,
          {
            ...
            text: "",
            type,
            options: type === "free_text" ? [] : ["Option A", "Option B"],
            pass_option_indices: [],
            required: true,
          },
        ],
        ...
        toggleRequired: (state, { id }) =>
          state.map((q) => (q.id === id ? { ...q, required: !q.required } : q)),
          ...
          state.map((q) => {
            ...
            return {
              ...
              pass_option_indices: has
                ...
                : [...q.pass_option_indices, optionIndex].sort((a, b) => a - b),
            };
          }),
      },
    ],
