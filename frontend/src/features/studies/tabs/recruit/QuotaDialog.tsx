    ...
    >
      <DialogContent className="max-w-lg">
            ...
            <div className="flex flex-col gap-2">
              {working.segments.map((seg, i) => (
                <div key={i} className="flex items-center gap-2">
                  <Input
                    value={seg.label}
                    onChange={(e) => updateSegmentLabel(i, e.target.value)}
                  ...
                  <Input
                    ...
                    value={seg.target}
                    onChange={(e) =>
                      updateSegmentTarget(i, parseInt(e.target.value, 10))
                    }
        ...
        <div className="flex items-center justify-end gap-2 border-t border-[color:var(--merism-hairline)] pt-4">
          <Button type="button" variant="ghost" onClick={closeQuotaDialog}>
            Cancel
          </Button>
