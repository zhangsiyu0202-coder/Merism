    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            {studiesLoading && studies.length === 0 ? (
                ...
                <EmptyPlaceholder text={t("studies.empty_tab_body", { tab: t(`studies.tabs.${activeTab}`).toLowerCase() })} />
            ) : (
                <>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-t border-[color:var(--merism-hairline)] pt-4">
            ...
            <div className="flex items-center gap-2">
                <select
                    ...
                    className="rounded-merism-md bg-merism-surface px-2 py-1 text-merism-label ring-1 ring-[color:var(--merism-hairline-strong)]"
                >
                    {[10, 20, 50].map((s) => (
                        <option key={s} value={s}>
                            {tPag("pagination.per_page", { n: s })}
                        </option>
                    ))}
                </select>
                <button
                ...
                <div className="flex flex-1 flex-col gap-1">
                    <div className="flex items-center gap-2">
                        ...
                        <Tag variant="outline" case="normal">
                            {tSR(`study.mode.${study.interview_mode}`, { defaultValue: study.interview_mode })}
                        </Tag>
                    </div>
