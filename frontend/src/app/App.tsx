...
function pickLayout(kind: "app" | "plain" | "participant" | undefined): ComponentType<{ children: React.ReactNode }> {
...
function SceneFallback(): JSX.Element {
    return (
        <div className="flex min-h-64 items-center justify-center text-sm text-merism-text-muted">
            <span aria-hidden="true" className="mr-2 inline-block h-2 w-2 animate-pulse rounded-full bg-merism-accent" />
            Loading…
        </div>
    )
}
