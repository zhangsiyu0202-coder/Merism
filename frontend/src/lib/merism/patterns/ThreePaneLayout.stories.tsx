      ...
      <ThreePaneLayout
        ...
        middle={
          <div className="flex flex-col gap-4">
            ...
            <LogicCard index={1} title="Tell me about your role.">
              <p className="text-merism-body-sm text-merism-text-muted">
                Builds rapport; captures context for later probes.
              </p>
            </LogicCard>
            <LogicCard index={2} title="What took you to our product recently?">
              <p className="text-merism-body-sm text-merism-text-muted">
      ...
      <ThreePaneLayout
        left={
          <nav className="flex flex-col gap-1">
            ...
            <a
              className="rounded-merism-md px-3 py-2 text-merism-label bg-merism-accent-soft text-merism-text"
              href="#"
            >
              Profile
            </a>
            <a
              className="rounded-merism-md px-3 py-2 text-merism-label text-merism-text-muted"
              href="#"
            >
              Workspace
            </a>
