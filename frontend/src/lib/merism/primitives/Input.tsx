...
export const InputLabel = forwardRef<HTMLLabelElement, LabelHTMLAttributes<HTMLLabelElement>>(
    ({ className, ...props }, ref) => (
        <label
            ref={ref}
            className={cn("text-sm font-medium leading-none text-merism-text", className)}
            {...props}
        />
    ),
)
...
export function InputHelperText({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
    return <p className={cn("text-xs text-merism-text-muted", className)} {...props} />
}

export function InputErrorText({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
    return <p className={cn("text-xs text-merism-danger", className)} role="alert" {...props} />
}
