...
const ENTITY_NAV: NavItem[] = [
  ...
  {
    scene: Scene.Repository,
    i18nKey: "nav.repository",
    label: "Repository",
    path: urls.repository(),
    icon: BookMarked,
  },
  {
    scene: Scene.Decisions,
    ...
    >
      ...
      <span
        ...
        className={cn(
          ...
          isActive ? "bg-merism-accent" : "bg-merism-text-subtle/60",
        )}
      />
    ...
    <div className="border-t border-[color:var(--merism-hairline)] p-2">
      ...
      <button
        ...
        className={cn(
          ...
          isCollapsed ? "justify-center w-full py-2" : "gap-3 px-3 py-1.5",
        )}
      >
        {isCollapsed ? (
